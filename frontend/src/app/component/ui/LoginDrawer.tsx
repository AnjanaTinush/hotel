...
const LoginDrawer: React.FC<LoginDrawerProps> = ({ isOpen, onClose, onSwitchToSignup }) => {
          ...
          >
            ...
            <div className="w-full lg:w-1/2 flex items-center justify-center p-8 bg-black relative overflow-y-auto">
              <div className="max-w-md w-full">
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    <input
                      ...
                      className="w-full px-6 py-4 bg-transparent border border-white/30 text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-white focus:border-transparent transition-all duration-200 text-sm tracking-wider"
                  ...
                  <div className="relative">
                    <input
                      ...
                      onChange={handleInputChange}
                      className="w-full px-6 py-4 pr-12 bg-transparent border border-white/30 text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-white focus:border-transparent transition-all duration-200 text-sm tracking-wider"
                  ...
                  <div className="flex items-center justify-between text-sm">
                    <div className="flex items-center">
                      <input
                        type="checkbox"
                        id="remember"
                        className="h-4 w-4 bg-transparent border-white/30 text-white focus:ring-white focus:ring-offset-black rounded"
                        disabled={isLoading}
                      />
                      <label htmlFor="remember" className="ml-2 block text-white/70 tracking-wide text-xs">
                        REMEMBER ME
                      </label>
                    </div>
                    <a 
                      href="#" 
                      className={`text-white/70 hover:text-white transition-colors duration-200 tracking-wide text-xs ${
                ...
                <div className="mt-8 text-center text-sm text-white">
                  <span className="tracking-wide text-gray-400 text-xs">DON'T HAVE AN ACCOUNT? </span>
                  <button
            ...
            <div className="hidden lg:flex lg:w-1/2 relative">
              ...
              <div className="absolute bottom-10 left-10 right-10 text-white">
                ...
                <p className="text-white/80">Experience luxury at Anjana Guest</p>
              </div>
            </div>
          </motion.div>
        </>
